...
public class Person
{
	...
	public void setEinkommensZusammensetzung(Map<String, ? extends Number> einkommensZusammensetzung)
	{
	...
	public void setEinkommensEntwicklung(Map<String, ? extends Number> einkommensEntwicklung)
	{
	...
	public Person(String vorname, String nachname, Integer anzahlKinder, Date geburtsdatum, Adresse adresse, List<Kontakt> kontaktDaten, Map<String, ? extends Number> einkommensZusammensetzung, Map<String, ? extends Number> einkommensEntwicklung)
	{
		super();
		this.vorname = vorname;
	...
	{
		return "Person [vorname=" + vorname + ", nachname=" + nachname + ", anzahlKinder=" + anzahlKinder + ", Geburtsdatum=" + Geburtsdatum + ", adresse=" + adresse + ", kontaktDaten=" + kontaktDaten + ", einkommensZusammensetzung=" + einkommensZusammensetzung + ", einkommensEntwicklung=" + einkommensEntwicklung + "]";
	}
