...
public class Person
{
	...
	public Person(String vorname, String nachname, Integer anzahlKinder, Date geburtsdatum, Adresse adresse, List<Kontakt> kontaktDaten, Map<String, ? extends Number> einkommensZusammensetzung, Map<String, ? extends Number> einkommensEntwicklung, Double durchschnittlichePromille)
	{
		super();
		this.durchschnittlichePromille = durchschnittlichePromille;
		this.vorname = vorname;
